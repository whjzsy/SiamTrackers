...
from SiamTFA.model import Model
...
# 初始化visdom窗口
viz = Visdom()
viz.line([[0.,0.,0.]], [0], win='train', opts=dict(title='train_loss', legend=['cls_loss', 'loc_loss', 'total_loss']))
...
def train(train_loader, model, optimizer, lr_scheduler, tb_writer):
    ...
    for idx, data in enumerate(train_loader):
        ...
        # 更新窗口图像
        if idx % 10 == 0:
            viz.line([[cls_loss.data.item(), loc_loss.data.item(), loss.data.item()]], [idx], win='train', update='append')
