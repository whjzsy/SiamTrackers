...
class DatasetFactory(object):
    ...
    def create_dataset(**kwargs):
        """
        Args:
            name: datasets name 'OTB2015', 'LaSOT', 'UAV123', 'NFS240', 'NFS30',
        ...
        Return:
            datasets
        """
        assert 'name' in kwargs, "should provide datasets name"
        name = kwargs['name']
        if 'OTB' in name:
            ...
            raise Exception("unknow datasets {}".format(kwargs['name']))
        return dataset
