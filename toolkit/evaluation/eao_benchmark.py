            ...
            for name, traj_len, failures, overlaps in zip(video_names, gt_traj_length,
                ...
                if len(failures) > 0:
                    ...
                    for i in range(len(points)):
                        ...
                        if i != len(points) - 1:
                            # tag_value = self.datasets[name].tags[tag][points[i]:points[i+1]+1]
                            ...
                            # tag_value = self.datasets[name].tags[tag][points[i]:len(overlaps)]
                    ...
                    # tag_value = self.datasets[name].tags[tag][:max_idx]
