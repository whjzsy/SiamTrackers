...
parser.add_argument('--snapshot', default='/home/ubuntu/Desktop/Object_Track/SiamTrackers/experiments/siamrpn_r50_l234_dwxcorr/model.pth', type=str, help='model name')
